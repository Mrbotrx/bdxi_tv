...
# ---------- FIND ALL m3u8 STREAMS (RECURSIVE) ----------
                ...
                if resp.status == 200:
                    ...
                    if streams:
                        return {
                            ...
                            "logo": logo,
                            "category": category,
                            "streams": streams  # All m3u8 streams found
                        }
                    else:
...
def generate_m3u(channels_data):
    if not channels_data:
        return make_header(0, 0) + "# No channels found\n"
...
async def main():
    print("=" * 60)
    print("🚀 STARTING IPTV PLAYLIST GENERATOR")
    print("=" * 60)
